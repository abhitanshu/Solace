@SDA @TradeFinance
Feature: Trade Finance Amendment use case for payment "At Maturity" when Checker approves the request created by Maker
...
#Calculate Remuneration fees
    * call read('classpath:features/common/CalculateFeesAmnd.feature')
