@SDA @TradeFinance
Feature: Trade Finance Annex Amendment along with Amendment use case for payment "At Maturity" when Checker approves the request created by Maker
...
#Create Annex
 ...
 #Create Annex amendment
    * notification.authorization_header = 'maker_abhi@example.com'
    * annexData.payload = createAnnexAmendmentByContractPayload
...
#Calculate Remuneration fees
    * call read('classpath:features/common/CalculateFeesAnnexAmnd.feature')
